...
@section('css-code')
    <link href="{{ asset('dashboard/assets/vendor/apexcharts/apexcharts.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dashboard/vendor/filepond/image-preview.min.css') }}" rel="stylesheet">
    <link href="{{ asset('dashboard/vendor/filepond/filepond.css') }}" rel="stylesheet">
@endsection
@section('content')
                        ...
                        <div class="card bg-success-300 project-details-card">
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    ...
                                    <span
                                        class="badge bg-transparent dashed-1-dark-light text-success-dark ms-2 p-1 b-r-10">Web Development</span>
                                </div>
                                <div class="my-4">
            ...
            <div class="col-lg-7 col-xxl-6 order-1-md">
                        ...
                        <div class="table-responsive app-scroll ">
                            <table class="table align-middle project-status-table mb-0">
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge text-light-warning f-s-9 f-w-700">In Progress</span>
                                    </td>
                                    ...
                                    <td>
                                                    <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                            class="ti ti-circle-filled me-2 f-s-6"></i> Design phase completed</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                                    <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                            class="ti ti-circle-filled me-2 f-s-6"></i> Project deployed successfully</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                                    <span class="text-dark f-s-14 f-w-500 text-nowrap"><i
                                                            class="ti ti-circle-filled me-2 f-s-6"></i> Campaign to begin in December</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                                     <span class="text-dark f-s-14 f-w-500 text-nowrap">
                                                         <i class="ti ti-circle-filled me-2 f-s-6"></i> Campaign launched successfully
                                                     </span>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="table-footer ">
                    ...
                    <ul class="pagination app-pagination justify-content-end ">
                        <li class="page-item disabled"><a class="page-link b-r-left"
                                                          href="#">Previous</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="task-container slider">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div aria-valuemax="100" aria-valuemin="0"
                                             aria-valuenow="25" class="progress w-100" role="progressbar">
                                            <div
                                                class="progress-bar bg-danger-dark progress-bar-striped progress-bar-animated"
                                                style="width: 68%"></div>
                                        </div>
                            ...
                            <div class="card">
                                <div
                                    class="d-flex justify-content-between align-items-center rounded p-1 bg-primary-300">
                                    ...
                                    <div class="d-flex gap-2">
                                                          <span
                                                              class="w-35 h-35 bg-white-300 text-info-dark rounded p-2 d-flex-center"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div aria-valuemax="100" aria-valuemin="0"
                                             aria-valuenow="25" class="progress w-100" role="progressbar">
                                            <div
                                                class="progress-bar bg-warning-dark progress-bar-striped progress-bar-animated"
                                                style="width: 35%"></div>
                                        </div>
                            ...
                            <div class="card">
                                <div
                                    class="d-flex justify-content-between align-items-center rounded p-1 bg-success-300">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60"
                                            ...
                                            <div
                                                class="progress-bar bg-info-dark progress-bar-striped progress-bar-animated"
                                                style="width: 60%"></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80"
                                             class="progress w-100" role="progressbar">
                                            <div
                                                class="progress-bar bg-success-dark progress-bar-striped progress-bar-animated"
                                                style="width: 80%"></div>
                                        </div>
