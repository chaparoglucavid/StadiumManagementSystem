            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.stadium-types.index') }}">
                ...
                <div class="card-body">
                    <div class="app-form">
                        ...
                        <form action="{{ route('admin.stadium-types.update', encrypt($type->uid)) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <!-- Tab Content -->
                                ...
                                <div class="col-6">
                                    <div class="floating-form mb-3">
                                        <select class="form-select" id="status" name="status">
                                            ...
                                            <option value="inactive" {{ $type->status === "inactive" ? 'selected' : '' }}>{{ t('inactive') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
