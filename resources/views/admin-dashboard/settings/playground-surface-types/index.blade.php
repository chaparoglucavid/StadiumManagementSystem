                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.playground-surface-types.create') }}">
                            <button class="btn btn-sm btn-outline-primary">
                                ...
                                {{ t('add new playground surface type') }}
                            </button>
                        </a>
                    </div>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="order-list-datatable table-responsive">
                        <table class="table table-bottom-border align-middle mb-0">
                            ...
                            <tr>
                                <th>№</th>
                                <th class="text-start" scope="col">{{ t('sport type') }}</th>
                                <th class="text-start" scope="col">{{ t('playground surface type') }}</th>
                            ...
                            @foreach($surfaceTypes as $key => $surfaceType)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge text-light-{{ $surfaceType->status === "active" ? 'success' : 'danger' }}">{{ $surfaceType->status === "active" ? t('active') : t('inactive') }}</span>
                                    </td>
                                    <td>
