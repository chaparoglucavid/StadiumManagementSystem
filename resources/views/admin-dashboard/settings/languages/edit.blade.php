            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>
                            {{ $language->getTranslation('name', app()->getLocale()) }} məlumatları
                        </h4>
                ...
                <div class="card-body">
                    <div class="app-form">
                        ...
                        <form action="{{ route('admin.languages.update', encrypt($language->uid)) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Tab Content -->
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="floating-form mb-3">
                                                    <input type="text" value="{{ $language->getTranslation('name', $lang_item->shortened) ?? '' }}" name="name[{{ $lang_item->shortened }}]"
                                            ...
                                            <div class="col-6">
                                                <div class="floating-form mb-3">
                                                    <input type="text" name="shortened[{{ $lang_item->shortened }}]"
                                                           class="form-control" value="{{ $language->getTranslation('shortened', $lang_item->shortened) ?? '' }}" placeholder="none">
                                                    <label class="form-label">Qısaldılmış forma ({{ $lang_item->name }})</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="floating-form mb-3">
                                        <select class="form-select" id="status" name="status">
                                            ...
                                            <option value="active" {{ $language->status === 'active' ? 'selected' : '' }}>Aktiv</option>
                                            <option value="inactive" {{ $language->status === 'inactive' ? 'selected' : '' }}>Deaktiv</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="floating-form mb-3">
                                        ...
                                        <img src="{{ asset('dashboard/images/logo/'.$language->icon) }}" height="75" class="mt-3">
                                    </div>
                                </div>
                            </div>
