            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4>
                            {{ $language->getTranslation('name', app()->getLocale()) }}
                        </h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="floating-form mb-3">
                                                    ...
                                                    <label class="form-label">{{ t('shortened') }} ({{ $lang_item->name }})</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="floating-form mb-3">
                                        <select class="form-select" id="status" name="status">
                                            ...
                                            <option value="active" {{ $language->status === 'active' ? 'selected' : '' }}>{{ t('active') }}</option>
                                            <option value="inactive" {{ $language->status === 'inactive' ? 'selected' : '' }}>{{ t('deactive') }}</option>
                                        </select>
                                    </div>
                                </div>
